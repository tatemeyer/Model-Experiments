...
margin below the observed 0.957-0.968 range for both.
...
| variant | relative L2 (seeds 0/1/2/7, horizon=5) |
|---|---|
| plain baseline, uniform (issue #23) | 0.9592, 0.9601, 0.9633, 0.9632 |
| plain baseline, causal, epsilon=1.0 (issue #23) | 0.9593, 0.9607, 0.9644, 0.9598 |
...
0.9592-0.9633, and two of four seeds (1.0844, 1.1015) are actually
